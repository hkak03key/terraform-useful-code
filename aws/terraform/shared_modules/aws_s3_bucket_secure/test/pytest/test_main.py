...
def test_s3_write_object(tfstate_skip_apply, delete_all_object, request, iam_role, s3_bucket, expect):
    root = tfstate_skip_apply

    aws_iam_role = root.aws_iam_role.defaults[iam_role]
    aws_s3_bucket = root.module.defaults[s3_bucket].module.aws_s3_bucket_core.aws_s3_bucket.default
...
def test_s3_read_object(tfstate_skip_apply, delete_all_object, request, iam_role, s3_bucket, expect):
    root = tfstate_skip_apply
